      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <div className="max-w-md mx-auto relative">
            ...
            <input type="text" placeholder="Search integrations..." value={searchQuery} onChange={e => setSearchQuery(e.target.value)} className="w-full pl-10 pr-4 py-3 bg-terminal-surface border border-terminal-surface rounded-lg focus:outline-none focus:ring-2 focus:ring-terminal-green/50 text-foreground placeholder-muted-foreground" />
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-terminal-surface/20">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-4">
            ...
            return <Button key={category.id} variant={isActive ? "default" : "outline"} onClick={() => setSelectedCategory(category.id)} className={`flex items-center gap-2 ${isActive ? 'bg-terminal-green hover:bg-terminal-green/90 text-background' : 'border-terminal-green/30 text-terminal-green hover:bg-terminal-green/10'}`}>
      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredIntegrations.map((integration, index) => <Dialog key={integration.id}>
                <DialogTrigger asChild>
                  <Card className="group cursor-pointer transition-all duration-300 hover:scale-105 hover:shadow-lg border-terminal-surface backdrop-blur-sm animate-fade-in" style={{
                  ...
                  <Tabs defaultValue="config" className="mt-6">
                    ...
                    <TabsContent value="config" className="space-y-4">
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          ...
                          <Button variant="outline" size="sm" onClick={() => copyToClipboard(integration.yamlConfig, 'yaml')} className="border-terminal-green/30 text-terminal-green hover:bg-terminal-green/10">
                            {copiedText === 'yaml' ? <CheckCircle className="w-4 h-4" /> : <Copy className="w-4 h-4" />}
                            Copy
                          </Button>
                        </div>
                    ...
                    <TabsContent value="install" className="space-y-4">
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          ...
                          <Button variant="outline" size="sm" onClick={() => copyToClipboard(integration.cliInstall, 'cli')} className="border-terminal-blue/30 text-terminal-blue hover:bg-terminal-blue/10">
                            {copiedText === 'cli' ? <CheckCircle className="w-4 h-4" /> : <Copy className="w-4 h-4" />}
                            Copy
                          </Button>
                        </div>
                        <Card className="bg-terminal-surface border-terminal-surface">
                        ...
                        <div className="pt-4">
                          <Button asChild className="bg-terminal-blue hover:bg-terminal-blue/90 text-white">
                            <a href={integration.docsUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
                    ...
                    <TabsContent value="features" className="space-y-4">
                      ...
                      <div className="grid gap-3">
                        {integration.features.map((feature, index) => <div key={index} className="flex items-center gap-3 p-3 bg-terminal-surface/50 rounded-lg">
                      ...
                      <div className="pt-4 flex items-center justify-between">
                        ...
                        <Button asChild variant="outline" className="border-terminal-green/30 text-terminal-green hover:bg-terminal-green/10">
          ...
          {filteredIntegrations.length === 0 && <div className="text-center py-16">
