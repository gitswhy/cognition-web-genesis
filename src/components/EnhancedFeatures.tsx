  ...
  const features = [
    {
      ...
      lottieData: null, // Would be actual Lottie data in production
      stats: '99.9% accuracy'
    },
    {
      icon: Zap,
              ...
              return (
                ...
                >
                  <Card className="h-full group relative overflow-hidden">
                    ...
                    <motion.div
                      className="absolute inset-0 border-2 border-primary/20 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
                      initial={false}
