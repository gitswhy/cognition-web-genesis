...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 w-full z-[99999] bg-background/95 backdrop-blur-lg border-b border-terminal-green/20 shadow-lg" style={{ position: 'fixed' }}>
